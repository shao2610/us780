...
#define MSM_ION_MM_SIZE            0x7400000 /* Need to be multiple of 64K */
#else
...
static struct wcd9xxx_pdata tabla20_platform_data = {
	...
	.micbias = {
		...
		.bias2_cfilt_sel = TABLA_CFILT3_SEL,
...
#if !defined(CONFIG_SII8334_MHL_TX) || !defined(CONFIG_LGE_WIRELESS_CHARGER_BQ24160)
...
#else
#ifndef CONFIG_LGE_WIRELESS_CHARGER_BQ24160
